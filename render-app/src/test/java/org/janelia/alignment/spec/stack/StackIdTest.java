...
public class StackIdTest {
    ...
    public void testNameValidation() throws Exception {
        ...
        final String[][] validNames = {
                ...
                // render.[8-24]__[27-30]__[33-109]__transform(112-120)
                { "89012345678901234", "7890",     "34567890123456789012345678901234567890123456789012345678901234567890123456789"}
        };
        ...
        final String[][] invalidNames = {
                ...
                // render.[8-24]__[27-30]__[33-110]__transform(113-121)
                { "89012345678901234", "7890",     "345678901234567890123456789012345678901234567890123456789012345678901234567890"}
        };
