...
public class MultiSemUtilitiesTest {
    ...
    public void testTileIdParsers() {
        ...
        assertEquals("scan005", MultiSemUtilities.getScanStringForTileId(tileId),
                     "invalid ScanStringForTileId");
        ...
        assertEquals("16", MultiSemUtilities.getSFOVIndexForTileId(manyScanTileId),
                     "invalid SFOVIndexForTileId");
        assertEquals("sc09876", MultiSemUtilities.getScanStringForTileId(manyScanTileId),
                     "invalid ScanStringForTileId");
    }
