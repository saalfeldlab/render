...
public class ConfigurableStreakCorrectorTest {
    ...
    public static void main(final String[] args) {
        ...
        // the images generated by this loop can be combined by Image > Stacks > Images to Stack to scroll through the
        // parameter values (the stack should already be ordered correctly since the order is created from image titles)
        for (int i = 10; i < 20; i++) {
            final SmoothMaskStreakCorrector globalCorrector = new SmoothMaskStreakCorrector(8,
                                                                                            5545,
                                                                                            10920,
                                                                                            15,
                                                                                            10,
                                                                                            0.0);
            final StreakCorrector corrector = new LocalSmoothMaskStreakCorrector(globalCorrector,
                                                                                 100,
                                                                                 (float) i, //15.0f
                                                                                 0.1f);
