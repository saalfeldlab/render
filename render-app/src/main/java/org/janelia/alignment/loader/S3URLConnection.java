 ...
 * <p>
 * Based on AWS S3 SDK sample code: <a href="http://docs.aws.amazon.com/AmazonS3/latest/dev/RetrievingObjectUsingJava.html">...</a>
 */
public class S3URLConnection extends URLConnection {
    ...
    private synchronized void connectToS3() throws IOException {
        if (! connected) {
            try {
                final String s3key;
                s3key = java.net.URLDecoder.decode(s3uri.getKey(), StandardCharsets.UTF_8);
