...
/**
 * Copy of {@link mpicbg.ij.SIFT} with Stephan Preibisch's scaling fix in {@link #extractFeatures}.
 */
public class SIFTWithFix extends FeatureTransform<FloatArray2DSIFT>
{
    /**
     * Constructor
     *
     ...
     */
    public SIFTWithFix( final FloatArray2DSIFT t )
    {
        super( t );
    }
