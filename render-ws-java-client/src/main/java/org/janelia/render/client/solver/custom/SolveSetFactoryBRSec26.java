...
public class SolveSetFactoryBRSec26 extends SolveSetFactory
{
			...
			final double defaultDynamicLambdaFactor )
	{
		...
		//18395-18893, 27570-28139, 33144-33677
		for ( int i = 18395; i <= 18893; ++i )
			this.additionalIssues.put( i, "problem" );

		for ( int i = 27570; i <= 28139; ++i )
			this.additionalIssues.put( i, "problem" );

		for ( int i = 33144; i <= 33677; ++i )
			this.additionalIssues.put( i, "problem" );
	}
