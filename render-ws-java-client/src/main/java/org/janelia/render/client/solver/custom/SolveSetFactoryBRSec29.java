...
public class SolveSetFactoryBRSec29 extends SolveSetFactory
{
			...
			final double defaultDynamicLambdaFactor )
	{
		...
		//22342-22888, 23383-23418, 26587-27094, 36694-37903, 38205
		for ( int i = 22342; i <= 22888; ++i )
			this.additionalIssues.put( i, "problem" );

		for ( int i = 23383; i <= 23418; ++i )
			this.additionalIssues.put( i, "problem" );

		for ( int i = 26587; i <= 27094; ++i )
			this.additionalIssues.put( i, "problem" );

		for ( int i = 36694; i <= 37903; ++i )
			this.additionalIssues.put( i, "problem" );

		this.additionalIssues.put( 38205, "problem" );
	}
