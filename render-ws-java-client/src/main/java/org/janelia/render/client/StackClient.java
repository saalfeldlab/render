 ...
 * A {@link org.janelia.alignment.Render} instance is first used to produce the full scale (level 0) boxes.
 * {@link org.janelia.alignment.mipmap.BoxMipmapGenerator} instances are then used to produce any requested down-sampled mipmaps.
 *
