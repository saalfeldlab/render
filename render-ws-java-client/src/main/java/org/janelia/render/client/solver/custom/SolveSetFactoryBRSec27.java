...
public class SolveSetFactoryBRSec27 extends SolveSetFactory
{
			...
			final double defaultDynamicLambdaFactor )
	{
		...
		//11649-12084, 17831-18342, 27847-28421
		for ( int i = 11649; i <= 12084; ++i )
			this.additionalIssues.put( i, "problem" );

		for ( int i = 17831; i <= 18342; ++i )
			this.additionalIssues.put( i, "problem" );

		for ( int i = 27847; i <= 28421; ++i )
			this.additionalIssues.put( i, "problem" );
	}
