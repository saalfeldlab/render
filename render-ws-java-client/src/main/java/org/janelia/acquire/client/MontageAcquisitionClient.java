...
import org.janelia.render.client.*;
...
public class MontageAcquisitionClient {
    ...
    public void processStacks()
            throws Exception {
        List<StackId> stacksToProcess = retrieveStackIds(parameters);
    ...
    public void processStack(final StackId stackId) throws IOException {
        ...
        List<Double> stackZValues = renderDataClient.getStackZValues(stackId.getStack());
